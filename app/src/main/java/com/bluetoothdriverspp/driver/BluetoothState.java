...
public class BluetoothState {
    ...
    public static String getStateDescription(int btState) {
        String resultado = "";

        if (btState == STATE_NONE) {
            resultado = "STATE_NONE";
        } else if (btState == STATE_LISTEN) {
            resultado = "STATE_LISTEN";
        } else if (btState == STATE_CONNECTING) {
            resultado = "STATE_CONNECTING";
        } else if (btState == STATE_CONNECTED) {
            resultado = "STATE_CONNECTED";
        } else if (btState == STATE_NULL) {
            resultado = "STATE_NULL";
        }
        return resultado;
    }
